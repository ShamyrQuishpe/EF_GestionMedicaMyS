        ...
        <div className="mb-8 flex flex-col items-center" >
          ...
          <ul className="mt-5">
                    <li className="text-center">
                        <Link to='/citashboard' className={`${urlActual === '/citashboard' ? 'text-slate-200 bg-gray-900 px-3 py-2 rounded-md text-center' : 'text-slate-100'} text-xl block mt-2 hover:text-slate-600`}>Listar</Link>
                    </li>
                    <li className="text-center">
                        <Link to='/citashboard/registrar' className={`${urlActual === '/citashboard/registrar' ? 'text-slate-100 bg-gray-900 px-3 py-2 rounded-md text-center' : 'text-slate-100'} text-xl block mt-2 hover:text-slate-600`}>Registrar</Link>
                    </li>
          </ul>
